...
export default function KarolGPage() {
  // Precios
  const cardPrice = 3200
  const transferPrice = 2800
  const ticketsRemaining = 8
      ...
      <div className="container mx-auto px-4 py-4 flex-grow">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold">
              Boletos <span className="text-teal-500">Karol G</span> Ciudad de México
            </h1>
            <p className="text-sm text-gray-600">
              sáb, 12 de jul de 2025 • 8:00 p.m. at{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            <div className="mb-6">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/descarga%20%283%29-8A5etXsVuEcEda2xGsKpwoqmkxitqh.jpeg"
                alt="Karol G"
                width={800}
                height={500}
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                ...
                <p className="mb-4">
                  ¡Karol G llega al Estadio Azteca con su gira mundial 2025! La artista colombiana presentará todos sus
                  éxitos en una noche inolvidable. No te pierdas la oportunidad de ver a la "Bichota" en vivo en uno de
                  los escenarios más emblemáticos de México.
                </p>

                <div className="bg-purple-50 p-4 rounded-lg border border-purple-100 mb-4">
                  <h3 className="font-bold text-purple-900 mb-2">El evento comienza en:</h3>
                  <CountdownTimer targetDate="2025-07-12T20:00:00" className="justify-center" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Sábado, 12 de julio de 2025, 8:00 p.m.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Estadio Azteca, CDMX</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">2.5 horas aproximadamente</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-0">
                <Tabs defaultValue="map">
                  ...
                  <TabsContent value="map" className="p-6">
                    <div className="mb-4">
                      <h3 className="text-lg font-bold mb-2">Mapa del Estadio Azteca</h3>
                      <div className="bg-white p-2 border rounded-lg">
                        <Image
                          src="/placeholder.svg?height=400&width=800"
                          alt="Mapa de asientos Estadio Azteca"
                          width={800}
                          height={400}
                    ...
                    <div className="mt-4">
                      ...
                      <div className="p-4 border rounded-lg bg-blue-50">
                        <p className="font-medium">
                          Zona: <span className="text-blue-600">Preferente</span>
                        </p>
                        <p className="text-sm text-gray-600 mt-2">
                          Los asientos están ubicados en la zona Preferente, con excelente visibilidad del escenario.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
