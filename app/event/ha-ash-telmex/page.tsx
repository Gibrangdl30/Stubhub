...
export default function HaAshTelmexPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-4 flex-grow">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold">
              Boletos <span className="text-teal-500">Ha*Ash</span> Zapopan
            </h1>
            <p className="text-sm text-gray-600">
              vie, 30 de may de 2025 • 9:00 p.m. at{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            <div className="mb-6">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/3270ae35e582df4f75869fd03245a186-aRV8JoG3za8HZBc09D9L9UQF3QDTIJ.webp"
                alt="Ha*Ash"
                width={800}
                height={500}
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                ...
                <p className="mb-4">
                  Ha*Ash regresa a Guadalajara con su nueva gira. El dúo conformado por las hermanas Hanna y Ashley
                  presentará todos sus éxitos en el Auditorio Telmex. No te pierdas esta oportunidad única de verlas en
                  vivo.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Viernes, 30 de mayo de 2025, 9:00 p.m.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 border rounded-lg bg-yellow-50">
                          <h4 className="font-bold text-yellow-800">Zona Amarilla</h4>
