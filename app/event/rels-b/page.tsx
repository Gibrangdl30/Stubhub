...
export default function RelsBPage() {
  // Precios
  const cardPrice = 1100
  const transferPrice = 850
  const ticketsRemaining = 3
        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold">
              Boletos <span className="text-teal-500">Rels B</span> Ciudad de México
            </h1>
            <p className="text-sm text-gray-600">
              jue, 04 de sep de 2025 • Por confirmar at{" "}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Jueves, 4 de septiembre de 2025</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Palacio de los Deportes, CDMX</p>
                    </div>
                  </div>
                  <div className="flex items-start">
              ...
              <CardContent className="p-0">
                <Tabs defaultValue="map">
                  ...
                  <TabsContent value="map" className="p-6">
                    <div className="mb-4">
                      <h3 className="text-lg font-bold mb-2">Mapa del Palacio de los Deportes</h3>
                      <div className="bg-white p-2 border rounded-lg">
                        <Image
                          src="/images/palacio-deportes-map.png"
                          alt="Mapa de asientos Palacio de los Deportes"
                          width={800}
                          height={800}
                    ...
                    <div className="mt-4">
                      ...
                      <div className="p-4 border rounded-lg bg-red-50">
                        <p className="font-medium">
                          Sección: <span className="text-red-600">E30</span> (Nivel E)
                        </p>
                        <p className="font-medium">
                          Fila: <span className="text-red-600">L</span>
                        </p>
                        <p className="font-medium">
                          Asientos: <span className="text-red-600">16, 17, 18</span>
                        </p>
                        <p className="text-sm text-gray-600 mt-2">
                          Los asientos están ubicados en el nivel superior (Nivel E), con buena visibilidad del
                          escenario.
                        </p>
                      </div>
                    </div>
