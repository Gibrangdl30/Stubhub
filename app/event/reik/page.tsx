...
export default function ReikPage() {
  const price = 4800
      ...
      <div className="container mx-auto px-4 py-4 flex-grow">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold">
              Boletos <span className="text-teal-500">Reik</span> Ciudad de México
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            <div className="mb-6">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bef878967fbecf48c9a43a5615c87103-Uap79Uap79Uap79Uap79Uap79Uap79.webp"
                alt="Reik"
                width={800}
                height={500}
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="mb-4">
                  Reik regresa a México con su gira 2025. No te pierdas la oportunidad de ver a este grupo en vivo y
                  disfrutar de todos sus éxitos. Fecha y lugar por confirmar. ¡Mantente atento a las actualizaciones!
                </p>
              </CardContent>
            </Card>
          </div>
